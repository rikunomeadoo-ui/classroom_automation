...
> ⚠️ **アカウントが異なる場合の注意**
> Google Classroomを使う「個人アカウント」と、塾の授業予定が入っている「シンゲキアカウント」が違う場合、このシステムはカレンダーを読み取れません。
> 必ず事前に **シンゲキアカウントのカレンダー設定から、個人アカウントへ対象カレンダーを「共有」** してください。
> その上で、以下の手順は **個人アカウントでログインした状態** で行ってください。
